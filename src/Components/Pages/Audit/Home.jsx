...
const initialValues = {
    ...
    fraudstername: "",
    actionTaken: "",
    fraudster_profession:"",
    technology_used_to_commit:"",
}
...
export default function Home() {
    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            ...
            fraudster_profession:Yup.string()
            .max(1000, "Must be 15 characters")
            .required('Causes of fraud Required'),
            technology_used_to_commit:Yup.string()
            .max(1000, "Must be 15 characters")
            .required('Causes of fraud Required'),
        ...
        onSubmit: (values) => {
            const data = {
                ...
                fraudster_profession:values.fraudster_profession,
                date_of_detection:values.date_of_detection,
                technology_used_to_commit:values.technology_used_to_commit,
            };
            ...
            <div className={styles.home}>
                ...
                <form onSubmit={formik.handleSubmit}>
                    ...
                    <div className={styles.alldiv}>
                        ...
                        <div className={styles.allform}>
                            ...
                            <div className={styles.form1}>
                                ...
                                <input
                                    ...
                                    placeholder='Please Enter Fraud Types Like Embezzlement, cheating, Forgery etc ......'
                                    onBlur={formik.handleBlur}
                            ...
                            <div className={styles.form1}>
                            <label>Technology Used to commit The Fraud<p><FaStarOfLife style={{ marginBottom: "12px" }} className='icon' size="0.5rem" color='red'></FaStarOfLife></p></label>
                            <input
                                name='technology_used_to_commit'
                                id='technology_used_to_commit'
                                onChange={formik.handleChange}
                                value={formik.values.technology_used_to_commit}
                                placeholder='Please Enter The techology used to commit the fraud'
                                onBlur={formik.handleBlur}
                                className={formik.touched.technology_used_to_commit && formik.errors.technology_used_to_commit ? styles.inputError : null}
                            >
                            </input>
                            {formik.touched.technology_used_to_commit && formik.errors.technology_used_to_commit ? <label className={styles.errors}>{formik.errors.technology_used_to_commit}</label> : null}
                        </div>
                        </div>
                        ...
                        <div className={styles.allform}>
                        <div className={styles.form1}>
                        <label>Suspected Fruadster Profession <p><FaStarOfLife style={{ marginBottom: "12px" }} className='icon' size="0.5rem" color='red'></FaStarOfLife></p></label>
                        <div>
                            <input
                                type="text"
                                name='fraudster_profession'
                                id='fraudster_profession'
                                onChange={formik.handleChange}
                                value={formik.values.fraudster_profession}
                                onBlur={formik.handleBlur}
                                className={formik.touched.fraudster_profession && formik.errors.fraudster_profession ? styles.inputError : null}
                                placeholder='Please Enter Frudester Profession'></input>
                        </div>
                        {formik.touched.fraudster_profession && formik.errors.fraudster_profession ? <label className={styles.errors}>{formik.errors.fraudster_profession}</label> : null}
                    </div>
                    <div className={styles.form1}>
                    <label>Date of Detection<p><FaStarOfLife style={{ marginBottom: "12px" }} className='icon' size="0.5rem" color='red'></FaStarOfLife></p></label>
                    <div>
                        <input
                            type="date"
                            ...
                            onChange={formik.handleChange}
                            value={formik.values.date_of_detection}
                            onBlur={formik.handleBlur}
                            className={formik.touched.date_of_detection && formik.errors.date_of_detection ? styles.inputError : null}
                        ></input>
                        {formik.touched.date_of_detection && formik.errors.date_of_detection ? <label className={styles.errors}>{formik.errors.date_of_detection}</label> : null}
                    </div>
                </div>
                        </div>
                        <div className={styles.form1}>
