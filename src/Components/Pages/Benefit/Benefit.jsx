...
export default function Benefit() {
  ...
  const loddata = async () => {
    const response = await axios.get("http://10.57.40.130:8022/api/fetch_fraud_assigned_to_benefit");
  ...
  const renderStatusButton = (params, fraudId, fraud_amount) => {
    return (
      <strong>
        <Button
          variant="contained"
          ...
          //style={{ marginLeft: 16 }}
          onClick={() => {
            navigate(`/Benefit_ActionTaken/${fraudId}/${fraud_amount}`);
          }}
        >
          Update Status
        </Button>
  ...
  const renderBenfitActionTakenButton = (params, fraudId) => {
    return (
      <strong>
        <Button
          variant="contained"
          ...
          //style={{ marginLeft: 16 }}
          onClick={() => {
            navigate(`/benfitActionTakenReport/${fraudId}`);
          }}
        >
          Action Taken report
        </Button>
  ...
  const columns = [
    ...
    },
    {
      field: "Status",
      width: 200,
      renderCell: (params) => renderStatusButton(params, params.row.fraud_id, params.row.amount_to_be_recovered),
    },
    {
      field: "Action Taken",
      width: 310,
      headerClassName: "column-header",
      cellClassName: "column-cell",
      renderCell: (params) => renderBenfitActionTakenButton(params, params.row.fraud_id),
    },
  ];
