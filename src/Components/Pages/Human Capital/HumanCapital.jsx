...
export default function HumanCapital() {
  ...
  const loddata = async () => {
    const response = await axios.get("http://10.57.40.130:8022/api/fetchfraudhr");
    ...
    return (
      <strong>
        <Button
          ...
          //style={{ marginLeft: 16 }}
          onClick={() => {
            navigate(`/tdmProcessingrepothr/${fraudId}`);
          }}
        >
          Report
        </Button>
  ...
  const columns = [
    ...
    // },
    {
      field: "Assign",
      width: 150,
      renderCell: (params) => renderUpdateButton(params, params.row.fraud_id, params.row.description),
    },
    {
      field: "Status",
      width: 200,
      renderCell: (params) => renderStatusButton(params, params.row.fraud_id, params.row.description),
    },
    {
      field: "Report",
      width: 200,
